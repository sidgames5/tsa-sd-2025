...
export default function FeaturesPage() {
  ...
  const FeatureCard = ({ icon, title, description, color, index }) => {
    ...
    return (
      <motion.div
        ...
        className={`rounded-2xl p-8 h-full flex flex-col bg-gradient-to-br ${color} shadow-lg hover:shadow-xl border ${
  ...
  return (
    <div 
      ref={containerRef}
      className={`min-h-screen w-full overflow-hidden mt-20 ${
        isDark ? "bg-gray-950" : "bg-gradient-to-b from-gray-50 to-gray-100"
      }`}
    >
      ...
      <div className="relative z-10 container mx-auto px-4 py-24 max-w-7xl">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className={`rounded-3xl p-8 md:p-16 mb-24 ${
            isDark ? "bg-gray-900/50 backdrop-blur-md" : "bg-white/80 backdrop-blur-sm"
          } border ${
          ...
          {showDemoModal && (
            ...
            >
              ...
              <motion.div
                ...
                className={`relative z-10 rounded-3xl p-8 max-w-4xl w-full ${
              ...
              >
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  >
                    <div className={`text-9xl p-12 rounded-2xl ${
                    ...
                    <div className="flex justify-between mt-6">
                      <motion.button
                        ...
                        className={`px-4 py-2 rounded-lg ${
                          isDark ? "bg-gray-700 hover:bg-gray-600" : "bg-gray-800 hover:bg-gray-900"
                        }`}
                      >
                        Previous
                      </motion.button>
