    ...
    return (
        <div className="relative flex flex-col justify-center items-center overflow-hidden">
            ...
            >
                ...
                <div className={`min-h-screen w-full ${cookies.darkMode ? "bg-gradient-to-r from-blue-950 via-stone-900 to-sky-950" : "bg-gradient-to-r from-green-100 via-stone-50 to-blue-100"}`} id="testimonials">
              ...
              ${isDarkMode
                        ...
                        <div className="mb-12 flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-10">
                            <motion.button
                                onClick={openModal}
                        ...
                        <div className="min-h-[60vh]">
                            {reviews.length === 0 ? (
                                <motion.p
                                    className={`${cookies.darkMode ? "text-white" : "text-gray-500"} text-center text-xl`}
                                    initial={{ opacity: 0 }}
                                    animate={{ opacity: 1 }}
                                    transition={{ duration: 0.5 }}
                                >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-center mt-2 pb-12">
                                    {reviews.map((review, index) => (
                                        <motion.div
                                            key={index}
                                            className={`${cookies.darkMode ? "bg-gradient-to-br from-black via-stone-950 to-black text-white" : "bg-stone-100 text-black"} shadow-xl rounded-xl p-6 w-full h-full border-t-4 ${index % 3 === 0
                                                ? "border-green-400"
                                                : index % 3 === 1
                                                    ? "border-blue-400"
                                                    : "border-yellow-400"
                                        ...
                                        >
                                            ...
                                            <motion.p
                                                className={`${cookies.darkMode ? "text-white" : "text-gray-700"} text-base break-words whitespace-pre-wrap`}
                                                initial={{ opacity: 0 }}
                                                animate={{ opacity: 1 }}
