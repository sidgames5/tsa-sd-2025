              ...
              {reviews.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-center mt-2 pb-12">
                  {reviews.map((review, index) => (
                    <motion.div
                      key={index}
                      className={`${cookies.darkMode ? "bg-gradient-to-br from-black via-stone-950 to-black text-white" : "bg-stone-100 text-black"} shadow-xl rounded-xl p-6 w-full h-full border-t-4 ${
                        index % 3 === 0
                          ? "border-green-400"
                          : index % 3 === 1
                          ? "border-blue-400"
