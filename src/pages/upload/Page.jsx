...
export default function UploadPage() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            formData.append("plantType", plantType); // 🚀 Add plant type
            ...
            >
                ...
                <div className="w-full mb-4 text-center">  
                    ...
                    <select
                        ...
                        className={`w-full p-2 rounded border text-center ${isDarkMode ? "bg-gray-700 border-gray-600 text-white" : "bg-white border-gray-300"}`}  // Added text-center here
                    >
                        <option value="" className="text-center">Select a Plant</option>  
                        <option value="Apple" className="text-center">Apple</option>
                        <option value="Blueberry" className="text-center">Blueberry</option>
                        <option value="Cherry" className="text-center">Cherry</option>
                        <option value="Corn" className="text-center">Corn</option>
                        <option value="Grape" className="text-center">Grape</option>
                        <option value="Orange" className="text-center">Orange</option>
                        <option value="Peach" className="text-center">Peach</option>
                        <option value="Potato" className="text-center">Potato</option>
                        <option value="Raspberry" className="text-center">Raspberry</option>
                        <option value="Soybean" className="text-center">Soybean</option>
                        <option value="Squash" className="text-center">Squash</option>
                        <option value="Strawberry" className="text-center">Strawberry</option>
                        <option value="Tomato" className="text-center">Tomato</option>
                    </select>
                </div>
