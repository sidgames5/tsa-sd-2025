...
dataset_path = "/path/to/new-plant-diseases-dataset"  # Update this path
...
bootstrapped_train_data = bootstrap_data(train_dataset, target_class="Healthy", multiplier=4)
